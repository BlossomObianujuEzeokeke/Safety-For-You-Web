                ...
                <div class="sm:flex sm:flex-col sm:items-center sm:justify-items-start mt-6 lg:mt-0 lg:flex-1">
                    <div class="px-10 grid gap-x-6 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div class="text-white space-y-6" id="socials-menu">
                            ...
                            <a href="https://www.instagram.com/safetyforyouservices/" target="_blank" class="flex space-x-4 mt-2 text-sm font-medium hover:text-gray-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <a href="https://www.tiktok.com/@safety4you1?_t=8pio4Ym3cW5&_r=1" target="_blank" class="flex space-x-4 mt-2 text-sm font-medium hover:text-gray-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
